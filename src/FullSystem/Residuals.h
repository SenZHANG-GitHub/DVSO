...
public:
	...
	// Sen -> if virtualStereoResFlag is true -> Set target to host->frame_right
	...
	// // SenFlagVS
	// Sen -> set Jacobians for virtual stereo residual
	bool virtualStereoResFlag = false;
	double linearizeVirtualStereo(CalibHessian* HCalib);
