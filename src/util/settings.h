...
extern bool setting_logID; // use id rather than timestamps
...
// Sen -> For virtual stereo residual
extern double baseline;
extern double focal_x;
extern double baselineXFocal;
extern float w_energyStereo;
extern int wStereoPosFlag; 
extern int wCorrectedFlag;
extern int wGradFlag;
extern float scaleEnergyLeftTHR;
extern float scaleWJI2SumTHR;

extern bool useVirtualStereo;
extern bool judgeSqrtHW; 
extern bool checkWarpValid;
extern bool maskWarpGrad;
